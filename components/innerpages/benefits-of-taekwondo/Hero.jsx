          ...
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                We help you ditch the endless cycle of switching between tools to
                get things done. Spotwizz is an all-in-one platform that helps you
                manage your projects, track your time, and collaborate with your team.
              </p>
            </div>
